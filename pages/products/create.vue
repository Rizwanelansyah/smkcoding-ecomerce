      ...
      <form @submit.prevent="createProduct">
        <div class="mb-6" v-for="(item, index) in formCreateProduct" :key="index">
          ...
          <input
            ...
            class="w-full bg-blue-500 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none file:bg-blue-700 file:border-none file:px-3 file:py-2 file:text-white file:mr-3"
