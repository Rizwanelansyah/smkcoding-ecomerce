export const products = [
    ...
    {
      id: 6,
      name: "Jam tangan Punya Agil yang hilang diambil arie",
      category: "Jam",
      price: 100,
      image: "/images/products/jam-1.png",
      isCart: false,
      description: "jam dinding yang diubah menjadi jam tangan",
    },
    {
      id: 7,
      name: "Baju sepuh rare dan legendary bintang 5 yang memiliki 1jt power",
      category: "Jam",
      price: 356,
      image: "/images/products/baju-2.png",
      isCart: false,
      description: "Baju sepuh dari jaman dinosaurus",
    }
  ];